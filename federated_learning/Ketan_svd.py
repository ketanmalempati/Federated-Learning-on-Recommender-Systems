...
# df = pd.read_csv('C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/df_electronics.csv')

data_list = []

# with open('C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/modcloth_final_data.json', 'r') as file:
#     for line in file:
...
train_df = pd.read_csv(r"C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/interactions_train.csv")

test_df = pd.read_csv(r"C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/interactions_test.csv")

validation_df = pd.read_csv(r"C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/interactions_validation.csv")

recipie = pd.read_csv(r"C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/RAW_recipes.csv")

user = pd.read_csv(r"C:/Users/Dell/Desktop/notes/San Jose State University/Sem3/CMPE 295A-01 Master Project I/RAW_interactions.csv")
# news_df = pd.read_csv('C:/Users/Dell/Downloads/MINDsmall_train/news.tsv', sep='\t', header=None, names=['NewsID', 'Category', 'Subcategory', 'Title', 'Abstract', 'URL', 'Title Entities', 'Abstract Entities'])
...
for i, part in enumerate(split_data):
    ...
    data = Dataset.load_from_df(part[["user_id","recipe_id","rating"]], reader)
    ...
    # train_test_split_index = train_test_split_index//n+1
    # raw_ratings_train = raw_ratings[idx*train_test_split_index:(idx+1)*train_test_split_index]
...
# predictions = agg_model.test(testset[100:])
